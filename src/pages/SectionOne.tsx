...
const SectionOne = () => {
  return (
    <div className="w-full sm:h-screen bg-gray-100 sm:flex">
      <div className="bg-blue-500 w-full px-5 py-5 sm:py-0 sm:px-2">
        <div className="flex justify-center items-center sm:h-screen">
          <div className="relative">
            <div className="flex flex-col justify-center w-[500px]">
              ...
              <p className="text-slate-300 font-thin sm:text-xl wrap-break-word sm:mt-5 z-[1]">
            ...
            <div className="absolute top-[-78px] right-[-19px] w-[200px]">
